...
Put on the headset, browse to `https://<YOUR-LAN-IP>:8443`, bypass the self-signed cert warning, and hit **Enter VR** (opaque virtual world) or **Enter AR** (Quest 3 full-color passthrough — the heart floats over your actual room).
